...
#define FOR_ALL_UNCONDITIONAL_ICU_FUNCTIONS \
    ...
    PER_FUNCTION_BLOCK(u_strcmp, libicuuc) \
    PER_FUNCTION_BLOCK(u_strcpy, libicuuc) \
    ...
    PER_FUNCTION_BLOCK(u_uastrcpy, libicuuc) \
    ...
    PER_FUNCTION_BLOCK(ucal_getNow, libicui18n) \
    PER_FUNCTION_BLOCK(ucal_getTimeZoneDisplayName, libicui18n) \
    PER_FUNCTION_BLOCK(ucal_open, libicui18n) \
    PER_FUNCTION_BLOCK(ucal_openTimeZoneIDEnumeration, libicui18n) \
    PER_FUNCTION_BLOCK(ucal_set, libicui18n) \
    PER_FUNCTION_BLOCK(ucal_setMillis, libicui18n) \
    ...
    PER_FUNCTION_BLOCK(udat_format, libicui18n) \
